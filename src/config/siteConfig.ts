...
export const siteConfig: SiteConfig = {
	title: "睡眠虾空间",
	subtitle: "",
	siteURL: "https://zz5zz3.github.io/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-07-31", // 站点开始运行日期，用于站点统计组件计算运行天数

	lang: SITE_LANG,

	themeColor: {
		hue: 165, // 与主页壁纸的薄荷青绿色调保持一致
		fixed: true, // 固定主题色，保持整体视觉一致
	},
	...
	banner: {
		...
		src: {
			desktop: "/assets/custom/home-background.png",
			mobile: "/assets/custom/home-background.png",
		}, // 使用本地横幅图片
